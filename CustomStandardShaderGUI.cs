    ...
    internal class CustomStandardShaderGUI : ShaderGUI
{
    ...
    void BlendModePopup()
    {
        EditorGUI.showMixedValue = http://blog.csdn.net/zhangyukof/article/details/blendMode.hasMixedValue;
        ...
        if (EditorGUI.EndChangeCheck())
        {
            ...
            blendMode.floatValue = http://blog.csdn.net/zhangyukof/article/details/(float)mode;
        }
    ...
    void DoEmissionArea(Material material)
    {
        ...
        if (emissionMap.textureValue != null && !hadEmissionTexture && emissionScaleUI.floatValue <= 0f)
            emissionScaleUI.floatValue = http://blog.csdn.net/zhangyukof/article/details/1.0f;
